...
mod tests {
    ...
    #[ignore]
    fn test_720p_60hz() {
        let result = test_encoding_at_resolution(1280, 720, 60, 60, EncoderMode::UltraLowLatency);
    ...
    #[ignore]
    fn test_1080p_60hz() {
        let result = test_encoding_at_resolution(1920, 1080, 60, 60, EncoderMode::UltraLowLatency);
    ...
    #[ignore]
    fn test_4k_60hz() {
        let result = test_encoding_at_resolution(3840, 2160, 60, 60, EncoderMode::UltraLowLatency);
