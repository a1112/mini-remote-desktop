...
impl Encoder {
    ...
    /// Takes an encoder input and outputs a bitstream while passing NVENC picture flags.
    pub fn encode_picture_with_flags<I: EncoderInput>(
        &self,
        input: &I,
        output: &BitStream,
        frame_count: usize,
        ...
        self.encoder.encode_picture_with_flags(
            input,
            output,
            frame_count,
            timestamp,
...
impl EncoderInternal {
    ...
    pub fn encode_picture<I: EncoderInput>(
        ...
        self.encode_picture_with_flags(
            input,
            output,
            frame_count,
            timestamp,
    ...
    pub fn encode_picture_with_flags<I: EncoderInput>(
        ...
        unsafe { &mut *params.as_mut_ptr() }.encode_pic_flags = encode_pic_flags;
