...
fn decoded_frame_to_render_frame(frame: &mrd_decode::DecodedFrame) -> RenderFrame {
    RenderFrame {
        ...
        pixel_format: match frame.pixel_format {
            ...
            mrd_decode::PixelFormat::I420 => RenderPixelFormat::Rgb24,
            mrd_decode::PixelFormat::Nv12 => RenderPixelFormat::Rgb24,
            mrd_decode::PixelFormat::P010 => RenderPixelFormat::Rgb24,
