 ...
 */
export async function ipcDeviceDetail(
  deviceId: string
): Promise<AdapterResult<DeviceDetailSnapshot>> {
  return invokeBridgeOrTauri<DeviceDetailSnapshot>(
    'ipc_device_detail',
    {
      deviceId,
    },
    ...
    responseField<DeviceDetailSnapshot>('detail')
  );
}
...
function browserDisplayResourceSnapshot(): SystemResourceSnapshot {
  ...
  return {
    ...
    gpu_usage_metrics_scope: 'unavailable',
    gpu_memory_metrics_scope: 'unavailable',
    network_rx_bps: 0,
    network_tx_bps: 0,
