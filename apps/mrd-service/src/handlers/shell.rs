...
use mrd_ipc::{
    IpcResponse, OpenUiReason, ShellStatusSnapshot, ShutdownMode, UiDetachReason, UiOpenStatus,
};
use std::{path::PathBuf, sync::Arc};

pub async fn open_ui(ui_launcher: &UiLauncherPortRef, reason: OpenUiReason) -> IpcResponse {
